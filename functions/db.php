...
/** Процесс формирования запроса для получения списка задач для всех проектов либо выбранного проекта и текущего пользователя с учетом строки поиска и фильтров по дате
@param mysqli $conn ресурс соединения с БД
@param int $userId ID пользователя
